...
@section('title', 'Add new meta data')
        ...
        <div class="col-md-12">
            ...
            <div class="card col-md-6">
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        <label>Value</label>
                        <input type="text" class="form-control" name="value" value="{{old('value')}}" placeholder="Enter Value" required>
                    </div>
                    <div class="form-group">
                        <label>Group Helper</label>
                        <input type="text" class="form-control" name="group_helper" value="{{old('group_helper')}}" placeholder="Enter Group helper">
                    </div>
